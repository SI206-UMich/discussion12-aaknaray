...
def problematic_salary(cur, conn):
    cur.execute('SELECT employees.first_name, employees.last_name, employees.salary, jobs.min_salary, jobs.max_salary FROM employees JOIN jobs = employees.job_id ON jobs.job_id')
    result = cur.fetchall()
